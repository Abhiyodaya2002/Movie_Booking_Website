  ...
  return (
    <Box width={"100%" } height={"100%"} margin={"auto"} marginTop={2}>
        <Box margin={"auto"} width={"80%"} height={"60vh"} padding={2}>
              <img src='https://cinemarumble.com/wp-content/uploads/2023/10/Jailer-Box-office-collection.jpg' alt='jailor' width={"100%"} height={"100%"}/>
        </Box>
    ...
    <Box display="flex" width="100%" justifyContent={"center"} flexWrap={"wrap"}>
      ...
      return  <MovieItem id={movie._id} title={movie.title} posterUrl={movie.posterUrl} releaseDate={movie.releaseDate} key={index} />
      })}  
    </Box>
